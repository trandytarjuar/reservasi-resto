...
class ReservasiWalkinController extends Controller
{
    public function store(Request $request)
{
    try {
        ...
        $reservasiData = $request->all();
        $reservasiData['tanggal_jam'] = Carbon::now(); // Gunakan waktu sekarang
        ...
        $response = [
            'Success' => 'Reservasi Meja Berhasil (Walk-in)',
        ];
